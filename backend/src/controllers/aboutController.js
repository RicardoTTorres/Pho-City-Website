    ...
    await pool.query(
      `INSERT INTO about_page_content
         (id, hero_title, hero_intro, hero_image_url,
          beginning_title, beginning_body, beginning_image_url, beginning_caption,
          food_title, food_body, food_image_url, food_caption, food_highlights,
          commitment_title, commitment_body, commitment_image_url, commitment_caption,
          closing_text,
       ...
       ON DUPLICATE KEY UPDATE
         ...
         beginning_caption      = VALUES(beginning_caption),
         food_title             = VALUES(food_title),
         food_body              = VALUES(food_body),
         food_image_url         = VALUES(food_image_url),
         food_caption           = VALUES(food_caption),
         food_highlights        = VALUES(food_highlights),
         ...
         commitment_caption     = VALUES(commitment_caption),
