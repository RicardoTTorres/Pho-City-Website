...
export default function MediaPage() {
  ...
  const mediaItems = [
    ...
    {
      id: 2,
      name: "pho-dac-biet.jpg",
      url: "/img/pho-dac-biet.jpg",
      size: "312 KB",
    },
    {
      id: 3,
      name: "spring-rolls.jpg",
      url: "/img/spring-rolls.jpg",
      size: "189 KB",
    },
  ];
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {mediaItems.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-lg border overflow-hidden group hover:shadow-md transition"
            >
